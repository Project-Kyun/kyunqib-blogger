 ...
 * ---------------------------------------------------
 */
(function(d){var g,c,f;g={speed:700,pause:4E3,showItems:1,mousePause:!0,height:0,animate:!0,margin:0,padding:0,startPaused:!1,autoAppend:!0};c={moveUp:function(a,b){return c.showNextItem(a,b,"up")},moveDown:function(a,b){return c.showNextItem(a,b,"down")},nextItemState:function(a,b){var e,c;c=a.element.children("ul.last-post-wrap");e=a.itemHeight;0<a.options.height&&(e=c.children("li.last-post-item:first").height());e+=a.options.margin+2*a.options.padding;return{height:e,options:a.options,el:a.element,obj:c,selector:"up"===b?
"li.last-post-item:first":"li.last-post-item:last",dir:b}},showNextItem:function(a,b,e){var d;d=c.nextItemState(a,e);d.el.trigger("vticker.beforeTick");e=d.obj.children(d.selector).clone(!0);"down"===d.dir&&d.obj.css("top","-"+d.height+"px").prepend(e);b&&b.animate?a.animating||c.animateNextItem(d,a):c.nonAnimatedNextItem(d);"up"===d.dir&&a.options.autoAppend&&e.appendTo(d.obj);return d.el.trigger("vticker.afterTick")},animateNextItem:function(a,b){b.animating=!0;return a.obj.animate("up"===a.dir?{top:"-="+a.height+"px"}:{top:0},
...
bindMousePausing:function(a){return function(a,e){return a.bind("mouseenter",function(){if(!e.isPaused)return e.pausedByCode=!0,c.stopInterval.call(this),f.pause.call(this,!0)}).bind("mouseleave",function(){if(!e.isPaused||e.pausedByCode)return e.pausedByCode=!1,f.pause.call(this,!1),c.startInterval.call(this)})}}(this),setItemLayout:function(a,b,c){var f;a.css({overflow:"hidden",position:"relative"}).children("ul").css({position:"absolute",margin:0,padding:0}).children("li.last-post-item").css({margin:c.margin,
padding:c.padding});return isNaN(c.height)||0===c.height?(a.children("ul").children("li.last-post-item").each(function(){if(d(this).height()>b.itemHeight)return b.itemHeight=d(this).height()}),a.children("ul").children("li.last-post-item").each(function(){return d(this).height(b.itemHeight)}),f=c.margin+2*c.padding,a.height((b.itemHeight+f)*c.showItems+c.margin)):a.height(c.height)},defaultStateAttribs:function(a,b){return{itemCount:a.children("ul").children("li.last-post-item").length,itemHeight:0,itemMargin:0,element:a,animating:!1,options:b,
...
var posts_no=10;var post_rilis=true;function post_latest(e){document.write('<ul class="last-post-wrap">');for(var l=0;l<posts_no;l++){var d,f=e.feed.entry[l],p=f.title.$t;if(l==e.feed.entry.length){break}for(var h=0;h<f.link.length;h++){if("replies"==f.link[h].rel&&"text/html"==f.link[h].type){var b=f.link[h].title,c=f.link[h].href}if("alternate"==f.link[h].rel){d=f.link[h].href;break}}var o=f.published.$t,m=o.substring(0,4),k=o.substring(5,7),g=o.substring(8,10),i=new Array;i[1]="January",i[2]="February",i[3]="March",i[4]="April",i[5]="May",i[6]="June",i[7]="July",i[8]="August",i[9]="September",i[10]="October",i[11]="November",i[12]="December",document.write('<li class="last-post-item">'),document.write('<span class="post-update">'+i[parseInt(k,10)]+" "+g+" "+m+"</span> <b>&gt;</b> "),1==post_rilis&&document.write('<span class="post_item"><a href="'+d+'" target ="_top">'+p+"</a></span>");var n="",a=0;document.write("</li>")}document.write("</ul>")};
$(function() {
  $('#rec-post').vTicker('init', {speed: 600, 
	mousePause: true,
    showItems: 1,
	height:30,
    padding:4});
